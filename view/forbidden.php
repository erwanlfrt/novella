...
<html>
  <head>
    ...
    <title>Novelis - Accès refusé</title>
  ...
  <body>
    ...
    <main>
      <div class="wrong__container">
        <h2 class="wrong__title">Vous n'êtes pas autorisé à accéder à cette page.</h2> 
        <a class="wrong__button" href="?action=home">Accueil</a>
      </div>
    </main>
  </body>
</html>